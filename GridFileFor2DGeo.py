...
data_file_name = r'E:\Python_Projects\Traditional_Index\GridFile\GridFile\data\60W_STR.txt'
# index_file_name = DATA + "/models/EP" + str(ep) + "/sim.idx"
index_file_name = r'E:\Python_Projects\Traditional_Index\GridFile\GridFile\index\grid.idx'
...
def Grid_File_Geo():
    ...
    file_path = r'E:\Python_Projects\传统索引\GridFile\GridFile\data'
    ...
    if ep <= 2:
        ...
        if ep == 2:
            for rang in ranges[250:]:
                ...
                record_sum += record_count
        time_end = time.time()
        print('平均查询时间:', (time_end - time_start) / query_count, 's')
        print('平均查询IO:', visit_time / query_count)
        print('返回结果总数:', record_sum)
